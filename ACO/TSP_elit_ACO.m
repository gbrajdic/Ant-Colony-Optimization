...
function [dbest,best_it]=TSP_elit_ACO(cities,Nants,a,b,rr,e,Q,maxit)
...
phmone=((e+Nants)/nn_len)*ones(Ncity,Ncity);% incicijalizacija feromona izmeðu gradova
...
for it=1:maxit
    ...
    for id=1:Ncity
        ph1(tour(ind,id),tour(ind,id+1))=1/dbest;
    end % id
